...
import type { FactureUpdateRequest } from '../models/FactureUpdateRequest';
...
export class FactureService {
    ...
    public static updateFacture(
        factureId: string,
        requestBody: FactureUpdateRequest,
    ): CancelablePromise<FactureResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/factures/{factureId}',
    ...
    /**
     * Envoyer un rappel de paiement pour la facture
     * @param factureId
     * @returns any OK
     * @throws ApiError
     */
    public static envoyerRappelPaiement(
        factureId: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/factures/{factureId}/rappel-paiement',
            path: {
                'factureId': factureId,
            },
        });
    ...
    /**
     * Générer et sauvegarder le PDF de la facture
     * @param factureId
     * @returns string OK
     * @throws ApiError
     */
    public static genererEtSauvegarderPdf(
        factureId: string,
    ): CancelablePromise<string> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/factures/{factureId}/generer-pdf',
            path: {
                'factureId': factureId,
            },
        });
     ...
     * @throws ApiError
     */
    public static envoyerFactureParEmail(
        factureId: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/factures/{factureId}/envoyer-email',
            path: {
                'factureId': factureId,
            },
        });
     ...
     * @throws ApiError
     */
    public static downloadFacturePdf(
        factureId: string,
    ): CancelablePromise<string> {
        return __request(OpenAPI, {
            method: 'GET',
    ...
    public static getFacturesByEtat(
        etat: 'BROUILLON' | 'ENVOYE' | 'PAYE' | 'PARTIELLEMENT_PAYE' | 'EN_RETARD' | 'ANNULE',
    ): CancelablePromise<Array<FactureResponse>> {
        return __request(OpenAPI, {
            method: 'GET',
