...
import type { LigneDevisCreateRequest } from '../models/LigneDevisCreateRequest';
import type { LigneDevisResponse } from '../models/LigneDevisResponse';
...
export class DevisService {
     ...
     * @param devisId
     * @param requestBody
     * @returns LigneDevisResponse OK
     * @throws ApiError
     */
    public static addLigneDevis(
        devisId: string,
        requestBody: LigneDevisCreateRequest,
    ): CancelablePromise<LigneDevisResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/devis/ligneDevis/{devisId}',
            path: {
                'devisId': devisId,
            },
            body: requestBody,
