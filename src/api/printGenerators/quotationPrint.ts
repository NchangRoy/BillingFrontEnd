...
<head>
    <meta charset="UTF-8">
    <title>Quotation - ${data.numeroDevis}</title>
    <style>
    ...
    <div class="a4-page">
        <header class="header">
            <div class="brand-section">
                ...
                <div class="doc-title">
                    <h1>Quotation</h1>
                    <p class="doc-ref">${data.numeroDevis}</p>
        ...
        <section class="info-grid">
            <div>
                <p class="section-label">Client Reference</p>
            ...
            <div class="date-box">
                <div class="date-row">
                    ...
                    <span class="date-value">${formatDate(data.dateCreation)}</span>
                </div>
                <div class="date-row">
                    <span class="date-label">Valid Until</span>
                    <span class="date-value" style="color: #2563eb;">${formatDate(data.dateValidite)}</span>
                </div>
            </div>
        </section>
        ...
        <footer class="footer">
            ...
            <div class="totals-box">
                ...
                <div class="grand-total-card">
                    ...
                    <div class="total-amount">${new Intl.NumberFormat('en-GB').format((data.applyVat ? data.montantTTC : data.montantHT) ?? 0)}</div>
                </div>
            </div>
        </footer>
    </div>
