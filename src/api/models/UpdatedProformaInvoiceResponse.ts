...
export type UpdatedProformaInvoiceResponse = {
    ...
    type?: string;
    statut?: UpdatedProformaInvoiceResponse.statut;
    montantTotal?: number;
    idClient?: string;
    nomClient?: string;
    ...
    applyVat:boolean
     dateSysteme?:string;
     modeReglement?:UpdatedProformaInvoiceResponse.modeReglement;
     nosRef?:string;
     vosRef?:string;
     nbreEcheance?:number;
...
export const MOCK_PROFORMA_INVOICE: UpdatedProformaInvoiceResponse[] = [
  {
    idProformaInvoice: "DV-2026-001",
    numeroProformaInvoice: "AG1-INV-T-2026-000124",
    dateCreation: "2026-01-10T11:00:00Z",
   
    type: "VENTE",
    statut: UpdatedProformaInvoiceResponse.statut.BROUILLON,
    idClient: "c001",
    ...
    applyVat: true,
    modeReglement: UpdatedProformaInvoiceResponse.modeReglement.ESPECES,
    lignesDevis: [
      {
        idProduit: "p002",
  ...
  {
    idProformaInvoice: "DV-2026-002",
    numeroProformaInvoice: "AG1-INV-T-2026-000125",
    dateCreation: "2026-01-10T11:15:00Z",
   
    type: "GROS",
    statut: UpdatedProformaInvoiceResponse.statut.ENVOYE,
    idClient: "c002",
    nomClient: "ABC Distributors",
    adresseClient: "Zone Industrielle, Yaoundé",
    emailClient: "contact@abc.com",
    applyVat: false,
    modeReglement: UpdatedProformaInvoiceResponse.modeReglement.VIREMENT,
    lignesDevis: [
      {
        idProduit: "p001",
        nomProduit: "Riz 25kg",
