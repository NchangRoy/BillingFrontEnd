        ...
        <div className="max-w-7xl mx-auto px-6 pt-16 md:pt-24 pb-28 grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10">
              <Link
                href="/login"
                className="flex items-center gap-2 bg-primary hover:bg-secondary-mid text-white px-8 py-4 rounded-2xl font-black text-sm shadow-xl shadow-primary/20 transition-all active:scale-95"
              >
          ...
          <div className="relative">
            ...
            <div className="rounded-[2rem] bg-white border border-secondary-light shadow-2xl shadow-primary/10 overflow-hidden rotate-1 hover:rotate-0 transition-transform duration-500">
              {/* fake window chrome */}
      ...
      <section id="workflow" className="bg-secondary-background border-y border-secondary-light">
        <div className="max-w-7xl mx-auto px-6 py-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-primary tracking-tight mb-3">One module, the whole workflow</h2>
            <p className="text-secondary-gray font-medium">From the first quotation to the final delivery note.</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 rounded-[2rem] bg-white border border-secondary-light p-10 flex flex-col justify-between">
              <div>
            ...
            <div className="rounded-[2rem] bg-primary p-10 flex flex-col justify-between text-white relative overflow-hidden">
              <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURES.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="p-8 rounded-[2rem] border border-secondary-light bg-white hover:shadow-xl hover:shadow-primary/5 hover:border-secondary-mid/20 hover:-translate-y-1 transition-all duration-300"
              >
