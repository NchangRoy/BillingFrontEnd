...
useEffect(() => {
 ...
 <div className="bg-white rounded-2xl shadow-sm border border-gray-100 " ref={containerRef}>
  ...
  <div className="p-6 grid grid-cols-12 gap-x-5 gap-y-6">
    ...
    <div className="col-span-12 md:col-span-4">
      <label className={labelStyles}>Valid Until</label>
      <input type="date" name="validityDate" className={inputStyles} value={formData.validityDate} onChange={handleInputChange} />
    </div>
